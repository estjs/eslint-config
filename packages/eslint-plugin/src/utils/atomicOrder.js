...
const orderList = [
	...
	['place-content'],
	['place-self'],
	['p', 'pa', 'px', 'py', 'pt', 'pr', 'pb', 'pl'],
	['m', 'ma', 'mx', 'my', 'mt', 'mr', 'mb', 'ml'],
	['color']['text'],
	...
	['outline'],
	['outline-none', 'outline-dashed', 'outline-dotted', 'outline-double', 'outline-hidden'],
	['outline-offset'],
	['ring-inset', 'ring-0', 'ring-1', 'ring-2', 'ring-4', 'ring-8'],
	['ring'],
