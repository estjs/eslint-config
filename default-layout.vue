<template>
  <a-layout class="w-full w-full flex flex-nowrap overflow-hidden">
    <a-layout-sider
      class="ml-base mr-base mr-base mt-base h-100vh flex-shrink-0" breakpoint="xl" :collapsed="collapsed" :collapsible="true" :hide-trigger="true" :width="menuWidth"
      @collapse="setCollapsed"
    >
      <div class="flex h-full flex-col overflow-auto overflow-x-hidden">
    ...
    <div class="h-100vh w-full overflow-hidden ma-0 column flex-1 pa-0">
